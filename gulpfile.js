...
lazyRequireTask('assets-imgs', './tasks/assets-imgs', {
  src: './app/imgs/**/*.*',
  dst: './dist/assets/'
});
...
gulp.task('build', gulp.series(
    'clean',
    gulp.parallel('styles', 'pages-pug', 'pages-html', 'assets-imgs', 'assets-js')
));
...
gulp.task('watch', function() {
  ...
  gulp.watch('./app/imgs/**/*.*', gulp.series('assets-imgs'));
  gulp.watch('./app/scripts/**/*.*', gulp.series('assets-js'));
});
